...
rclone を止めた直後にアプリを起動し直すと、外れる前のマウントが表に残っていることがある。
そこを「繋がっている」と見なすと、応答しないマウントを繋がっていると報せることになる。

**引き継ぐ前に読み出しを試す。** 返らなければ抜け殻として外し、改めてマウントする。
起動時に状態を決め打ちすることもやめた。決めるのはマウントの手続きの中だけにする。
